...
class App extends React.PureComponent {
  ...
  moveTask = id => {
    ...
    }).then(res => alert("Move Successful"));
  };
        ...
        >
          ...
          <MenuItem
            onPress={() => {
              ...
              this.setState({ menuType: "preview" });
            }}
          >
            Preview
          </MenuItem>
          ...
          <MenuItem
            onPress={() => {
              ...
              this.setState({ menuType: "addtoedms" });
            }}
          >
            Add to EDMS
          </MenuItem>
