...
const ModalOptions = function(props) {
  ...
  const [statDetails, setStatDetails] = useState(true);
  const [statsList, setStatsList] = useState([
    {
      workflowTitle: "Adhoc Correspondence",
      workflowTitleAr: "Adhoc Correspondence",
      totalCreated: 5,
      approvedOrReviewed: 0,
      rejected: 0,
      pending: 4,
      pendingWithApprovar: 0
    },
    {
      workflowTitle: "MOM Workflow",
      workflowTitleAr: "MOM Workflow",
      totalCreated: 0,
      approvedOrReviewed: 0,
      rejected: 0,
      pending: 0,
    ...
    {
      workflowTitle: "Adhoc Task",
      workflowTitleAr: "Adhoc Task",
      totalCreated: 1,
      approvedOrReviewed: 0,
      rejected: 0,
      pending: 0,
    ...
    {
      workflowTitle: "Process Approval",
      workflowTitleAr: "موافقة على عملية",
      totalCreated: 2,
      approvedOrReviewed: 0,
      rejected: 0,
      pending: 0,
